...
![Makefile](image/10.png){ #fig:005 width=70% } 
...
- Для просмотра определённых строк не основного файла используйтеlistс параметрами:list calculate.c:20,29;

![Установка и удаление точки останова](image/06.png){ #fig:009 width=70% } 

- Установила точку останова в файле calculate.c на строке номер 21 командой break21 (рис. 3.9);
...
![Код файла calculate.c](image/07.png){ #fig:010 width=70% } 

![Код файла main.c](image/08.png){ #fig:011 width=70% } 
